...
The human-readable scan summary reports the number of detected physical input files, the known candidates discovery ignored, and the distinct component ecosystems in ordinal order; a scan with no identified component ecosystem reports `none`.
