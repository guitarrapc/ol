...
public static class OlDefaults
{
    ...
    public static bool TryCreatePackageMetadataRequest(Utf8Slice purl, out PackageMetadataRequest request)
    ...
    public static bool TryCreatePackageMetadataRequest(Utf8Slice purl, out PackageMetadataRequest request, out bool ecosystemSupported)
